...
export default class WeatherSingaraja extends React.Component {
  constructor(props){
    super(props)
    this.state = {
      city:'',
  ...
  getWeather= () => {
    let url = 'http://api.openweathermap.org/data/2.5/weather?q=' + this.state.city + '&appid=401f2eafd62ec85404be8501d4aa245b&units=metric';
    fetch (url)
  ...
  render() {
    ...
    <View style={styles.containerMain}>
      ...
      <View style={styles.box1}>
          <Text style={{ textAlign: 'center', color: 'white', padding: 12, fontSize: 17 }} > copyright @melatipramesti2018 </Text>
      </View>
